package com.example.sd.indianquizapp;
...
import com.example.sd.indianquizapp.BroadcastReceiver.AlarmReceiver;
import com.example.sd.indianquizapp.Model.User;
import com.example.sd.indianquizapp.BroadcastReceiver.AlarmReceiver;
import com.example.sd.indianquizapp.Model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editUser = (MaterialEditText) findViewById(R.id.Username);
    ...
    private void showDialog() {        //signup dialog
        AlertDialog.Builder alertdialog = new AlertDialog.Builder(MainActivity.this);
        alertdialog.setTitle("Sign Up");
        alertdialog.setMessage("Please fill the credentials");
        LayoutInflater layoutInflater = this.getLayoutInflater();              //turn xml files into view hierarchies.
